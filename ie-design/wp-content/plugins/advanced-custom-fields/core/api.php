...
function acf_form_head()
{
	...
	if( isset($_POST['acf_nonce']) && wp_verify_nonce($_POST['acf_nonce'], 'input') )
	{
		...
		// custom variable added by DO IT SIMPLY 9 - June - 2015
...
function acf_form( $options = array() )
{
	...
	<div style="display:none">
		...
		<!--custom input variable added by DO IT SIMPLY 9 - June - 2015-->
		<input type="hidden" name="form_type" value="<?php echo $options['form_attributes']['id']; ?>" />
